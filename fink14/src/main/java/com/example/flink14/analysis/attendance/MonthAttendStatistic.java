...
public class MonthAttendStatistic {
    ...
    private static final Logger log = LoggerFactory.getLogger(MonthAttendStatistic.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String tables = String.join(",", sourceColumnMap.keySet());

        Table resultTable = tableEnvironment.from("sourceTable").select(tables);
    ...
    public static Map<String, String> queryTableSchema(TableEnvironment tableEnvironment, String dbName, String tableName) {
        ...
        CloseableIterator<Row> schemaTable = tableEnvironment.from("schemaTable").select("TABLE_SCHEMA,TABLE_NAME,COLUMN_NAME,"
                + "DATA_TYPE").filter("TABLE_SCHEMA = '" + dbName + "'").where("TABLE_NAME = '" + tableName + "'")
